...
QT_MOC_LITERAL(3, 23, 12) // "slotOpenfile"

    },
    "MyMenu\0signalOpenfile\0\0slotOpenfile"
};
...
void MyMenu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalOpenfile((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (MyMenu::*_t)(QString );
...
// SIGNAL 0
void MyMenu::signalOpenfile(QString _t1)
{
